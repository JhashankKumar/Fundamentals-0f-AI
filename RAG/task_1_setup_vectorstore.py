...
Key Concept: This creates the infrastructure that RAG needs to store and retrieve document chunks based on meaning, 
not just keywords. Think of it as building the "brain's memory" where your AI will search for answers!
"""
#!/usr/bin/env python3
"""
